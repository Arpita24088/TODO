...
import { readTodos , createTodos,updateTodos,deleteTodos } from "./functions";
import Preloader from './components/Preloader';
import React from 'react';
//import { deleteTodos } from "../../server/controller/todos";
  ...
  </div>
  {
    !todos?<Preloader/>:todos.length>0?<ul className="collection">
      ...
      onClick={()=>setCurrentId(todo._id)}
       className="collection-item"><div><h5>{todo.title}</h5><p>{todo.content}<a href="#!"
